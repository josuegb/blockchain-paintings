...
var StubHelper = /** @class */ (function () {
     ...
     * @returns {Promise<any>}
     */
    StubHelper.prototype.getQueryResultAsList = function (query, keyValue) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.stub.getQueryResult(queryString)];
                    case 1:
                        iterator = _a.sent();
                        if (keyValue) {
     ...
     * @param endKey
     */
    StubHelper.prototype.getStateByRangeAsList = function (startKey, endKey) {
        return __awaiter(this, void 0, void 0, function () {
            var iterator;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.stub.getStateByRange(startKey, endKey)];
                    case 1:
                        iterator = _a.sent();
                        return [2 /*return*/, datatransform_1.Transform.iteratorToList(iterator)];
                }
     ...
     */
    StubHelper.prototype.deleteAllReturnedByQuery = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var allResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getQueryResultAsList(query, true)];
                    case 1:
                        allResults = (_a.sent());
                        return [2 /*return*/, Promise.all(allResults.map(function (record) { return _this.stub.deleteState(record.key); }))];
                }
            });
        });
    };
     ...
     * @param value
     */
    StubHelper.prototype.putState = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    StubHelper.prototype.getStateAsObject = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var valueAsBytes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.stub.getState(key)];
                    case 1:
     ...
     */
    StubHelper.prototype.getStateAsString = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var valueAsBytes;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    StubHelper.prototype.getStateAsDate = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var valueAsBytes;
            return __generator(this, function (_a) {
                switch (_a.label) {
